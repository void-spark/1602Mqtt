...
scp "$PWD/build/1602.bin" root@debian.fritz.box:/tmp/esp32
...
docker run --init -it --rm efrecon/mqtt-client sh -c "pub -h debian.fritz.box -t 'devices/083af2512be8/\$update' -m true ; sub -h debian.fritz.box -t 'devices/083af2512be8/\$state' -C 3 -R -v"
